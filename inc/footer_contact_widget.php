...
class footer_contact_widget extends WP_Widget
{
    ...
    {
        parent::__construct(false, $name = 'Kontakt stopka');
    }
...
<p>
    ...
    <textarea id="<?php echo $this->get_field_id('message'); ?>" class="widefat"
        name="<?php echo $this->get_field_name('message'); ?>" rows=6><?php echo $message; ?></textarea>
</p>

<?php
}
}
function footer_contact_widget_init()
{
    return register_widget('footer_contact_widget');
}
add_action('widgets_init', 'footer_contact_widget_init');
