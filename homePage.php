...
if (has_custom_logo()) {
    ...
    '" alt="' .
    get_bloginfo("name") .
        '" class="fixed hidden h-52 top-3/4 right-12 lg:block rounded-full">';
} else {
    echo "<h1>" . get_bloginfo("name") . "</h1>";
}
?>
    <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
      <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5"> <?php dynamic_sidebar("home-1");?> <div
